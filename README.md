...
- **Org:** `dut-pbl6-2026`
- **Tech:** .NET Web API
- **Branch flow:** `feature/* → develop → release/* → main` (see [job-platform-docs/.github/git-strategy.md](https://github.com/dut-pbl6-2026/job-platform-docs/blob/main/.github/git-strategy.md))
